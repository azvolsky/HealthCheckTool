...
import org.healthchecktool.reporter.reporter;
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource().equals(buttonAccept)) {
            if(protocol.getText().isEmpty() || host.getText().isEmpty() || port.getText().isEmpty() ||
                ...
                System.out.println(conf.getValueByKey("scenarioPath"));
                String content=null;
                try {
                    ...
                    reporter report = new reporter(conf.getValueByKey("reportPath"),jhi.getResult());
                    report.createExcel();
                }
                catch(Exception e) {
                    e.printStackTrace();

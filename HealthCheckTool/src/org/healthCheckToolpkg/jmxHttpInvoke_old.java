...
public class jmxHttpInvoke_old {
    private 	String 		host;
    private 	int 		port;
    private 	String 		user;
    private 	String 		pass;
    ...
    //############################CONSTRUCTORS#################################################################
    public jmxHttpInvoke_old() {
    }
    public jmxHttpInvoke_old(String host, int port, String user, String pass) {
        setJmxInvokeCredentials(host,port,user,pass);
    }
    public jmxHttpInvoke_old(String service, String method, Object params[], String host, int port, String user, String pass) {
        setJmxInvokeCredentials(host,port,user,pass);
        setJmxInvokeMethod(service,method,params);
    }
    public jmxHttpInvoke_old(String service, String method, Object params[], String host, int port, String user, String pass, logger log) {
        setJmxInvokeCredentials(host,port,user,pass);
        setJmxInvokeMethod(service,method,params);
        setLog(log);
    }
